        ...
        <form className="mt-5 rounded-xl p-5" >
            ...
            <div>
              <div className="flex flex-col   ">
                ...
                <input value={meeting.note} name="note"  className="px-5 shadow w-auto h-12 rounded-xl sm:w-auto lg:w-auto"></input>
            </div>
            
            <div className="flex flex-col mb-5">
                <label className="after:content-['*'] after:ml-0.5 after:text-red-500 pb-3 pt-4">อื่น ๆ</label>
                <input value={meeting.others} placeholder="อื่น ๆ" className="px-5 shadow w-auto h-28 rounded-xl sm:w-auto lg:w-auto" ></input>
...
/* <div className="flex flex-row justify-between ">
                <button onClick={()=>router.push(`/student/yourproject/${pid}/standupmeeting`)} className="w-44 h-12 border cursor-pointer rounded-xl border-danger hover:bg-danger hover:text-white text-danger text-center  ml-5 sm:ml-24 md:mr-9 ">ยกเลิก</button>
