...
export default function(params){
 ...
 // console.log("params",task_set);
  ...
  const handleDeleteTask =(task)=>{
    client.delete(`/api/subject/${subjectID[0]}/project/${pid}/productbacklog/${bid}/task-delete/${task.id}`)
    .then((res)=>{
          ...
          <div key={task.id} {...task} >
            ...
            <div className="border rounded-lg border-success my-5 px-5 w-full h-11 flex flex-row justify-between">
              ...
              <div className="flex flex-row justify-end ">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 my-2" onClick={() => handleDeleteTask(task)}>
