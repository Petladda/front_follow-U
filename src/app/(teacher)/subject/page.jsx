...
export default function(){
    ...
    async function loadSubject() {
        try {
            const response = await client.get("/api/subject/");
            setSubject(response.data)
            //console.log("loadsubject = ",response);
        } catch (error) {
            console.error(error);
            }
        }
            ...
            return (
                <div key={e.id} {...e} className="border mb-2 rounded-lg my-2 px-5 w-full h-11 flex flex-row justify-between">
                    ...
                    <div className="flex flex-row justify-end ">
                        ...
                        <svg onClick={()=>{deleteSubject(e)}}  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 my-2" >
